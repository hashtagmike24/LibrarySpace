...
public class IndividualActivity extends ActionBarActivity implements OnItemSelectedListener, PostRequest.AsyncResponsePOST{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rooms.add("Select a carrel");
        rooms.add("Carrel F4-13");
        rooms.add("Carrel F4-14");
        _room = "Select a carrel";
        ...
        myCalendar.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(CalendarView view, int year, int month, int dayOfMonth) {
                ...
                PostRequest pr = new PostRequest(IndividualActivity.this);
                pr.execute("http://csusb.libcal.com/process_roombookings.php?m=calscroll&gid=3889&date=" + formattedDate, json, "calendarPOST");
    ...
    public void conditionsButtonOnClick(View view)
    {
        ...
        if(_room.equals("Select a carrel")) // NOPE
            Toast.makeText(getApplicationContext(), "Please select a carrel", Toast.LENGTH_LONG).show();
    ...
    public void processPOSTFinish(String output)
    {
        ...
        // black magic
        Pattern pattern = Pattern.compile("(id=\\\"(\\w*)\\\"\\s(\\S*)\\s(\\S*)\\s\\w\\d\\W\\d\\d\\S*\\s\\W\\s\\d*\\W\\d*\\S*)");
    ...
    {
        return "{ 'm':'calscroll','gid':3889,'date':'" + date + "'}";
    }

    private ArrayList<String> populateRoomList()
    {
        ArrayList<String> temp = new ArrayList<String>();
        temp.add("Select a carrel");
        temp.add("Carrel F4-13");
        temp.add("Carrel F4-14");
    ...
    private ArrayList<String> getHoursBasedOnRoom()
    {
        ...
        if(_room.equals("Select a carrel"))
        {
